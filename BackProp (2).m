...
semuaangry=[angrymfcc{1,1};angrymfcc{1,2};
            ...
            angrymfcc{1,13};angrymfcc{1,14};angrymfcc{1,15}]';
semuasad=[sadmfcc{1,1};sadmfcc{1,2};
          sadmfcc{1,3};sadmfcc{1,4};
           ...
           sadmfcc{1,13};sadmfcc{1,14};sadmfcc{1,15}]';
semuanormal=[normalmfcc{1,1};normalmfcc{1,2};
           ...
           normalmfcc{1,13};normalmfcc{1,14};normalmfcc{1,15}]';
...
%-----------------------------------------------------------------------------------
%Feedforward
net=newff(minmax(Inputn),[5 1],{'logsig' 'purelin'},'traingdm');
