...
%satuuji;
%ujiamfcc;
buatmodel(angrymfcc, sadmfcc, normalmfcc);
ujisatu=signal;
ujimfcc=mfcc(ujisatu);
save('ujisatu','ujimfcc');
codebook;
hitungjaraknya(r1,r2,r3,ujimfcc);
if (jaraknya1<jaraknya2)&(jaraknya1<jaraknya3)
    set(handles.text8,'string','Ini emosi marah');
else
    if (jaraknya2<jaraknya1)&(jaraknya2<jaraknya3)
